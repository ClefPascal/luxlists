...
const Footer: React.FC = () => {
  return (
    <footer className="w-full bg-white dark:bg-surface-dark py-12 px-6 border-t border-gray-200 dark:border-gray-800 mt-auto">
      <div className="max-w-md mx-auto flex flex-col items-center gap-8">
        <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-primary/10 text-primary mb-2">
        ...
        <div className="flex flex-wrap justify-center gap-x-8 gap-y-2 text-sm font-medium text-slate-500 dark:text-slate-400">
        ...
        <p className="text-xs text-slate-400 dark:text-slate-600">
          © 2024 LuxeList. All rights reserved.
        </p>
      </div>
    </footer>
  );
